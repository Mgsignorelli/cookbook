...
class AllergyTest(unittest.TestCase):
    ...
    def test_updating_an_allergy_in_the_database(self):
        ...
        repositories.AllergyRepository.update(id=allergy.id, name=fake.word())
        allergy = repositories.AllergyRepository.get()[0]
    ...
    def test_deleting_an_allergy_in_the_database(self):
        ...
        repositories.AllergyRepository.delete(id=allergy.id)
        self.assertIsNone(repositories.AllergyRepository.find(id=found_allergy_id))
...
class CategoryTest(unittest.TestCase):
    ...
    def test_updating_a_category_in_the_database(self):
        ...
        repositories.CategoryRepository.update(id=category.id, name=fake.word())
        category = repositories.CategoryRepository.get()[0]
    ...
    def test_deleting_a_category_in_the_database(self):
        ...
        repositories.CategoryRepository.delete(id=category.id)
        self.assertIsNone(repositories.CategoryRepository.find(id=found_category_id))
...
class IngredientTest(unittest.TestCase):
    ...
    def test_updating_an_ingredient_in_the_database(self):
        ...
        repositories.IngredientRepository.update(id=ingredient.id, name=fake.word(), allergies=ingredient.allergies)
        ingredient = repositories.IngredientRepository.get()[0]
    ...
    def test_deleting_an_ingredient_in_the_database(self):
        ...
        repositories.IngredientRepository.delete(id=ingredient.id)
        self.assertIsNone(repositories.IngredientRepository.find(id=found_ingredient_id))
...
class RecipeTest(unittest.TestCase):
    ...
    def test_updating_a_recipe_in_the_database(self):
        ...
        repositories.RecipeRepository.update(id=recipe.id, title=fake.word())
        ...
        repositories.RecipeRepository.update(id=recipe.id, method="\n".join(fake.paragraphs(nb=3)))
        recipe = repositories.RecipeRepository.find(recipe.id)
        self.assertNotEqual(recipe.method, found_recipe_method)

        found_recipe_ingredients = recipe.ingredients
        repositories.RecipeRepository.update(id=recipe.id, ingredients=['2'])
        recipe = repositories.RecipeRepository.find(recipe.id)
        self.assertNotIn('1', recipe.ingredients.id)

        found_recipe_categories = recipe.categories
        repositories.RecipeRepository.update(id=recipe.id, categories=['2'])
        recipe = repositories.RecipeRepository.find(recipe.id)
    ...
    def test_deleting_a_recipe_in_the_database(self):
        ...
        repositories.RecipeRepository.delete(id=recipe.id)
        self.assertIsNone(repositories.RecipeRepository.find(id=found_recipe_id))
...
class UserTest(unittest.TestCase):
    ...
    def test_deleting_a_user_in_the_database(self):
        ...
        repositories.UserRepository.delete(id=user.id)
        self.assertIsNone(repositories.UserRepository.find(id=found_user_id))
